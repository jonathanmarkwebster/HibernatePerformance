...
public class BidirectionalOneToOneForwardFetchingTest extends HibernateTest {
...
//				return session.createQuery("FROM A as a JOIN FETCH a.b").list()  ;
		...
		Set<Results> results = runTests(annotationLeft, annotationRight, 1, testMode );
		printResultsWithGrid(results);
